...
void InProcessNode::init(const Callback& callback) {
  ...
  if (state != NOT_INITIALIZED) {
    ...
    protocol.addObserver(static_cast<cn::ICryptoNoteProtocolObserver*>(this));
    core.addObserver(static_cast<cn::ICoreObserver*>(this));

    work.reset(new boost::asio::executor_work_guard<boost::asio::io_context::executor_type>(ioService.get_executor()));
...
bool InProcessNode::doShutdown() {
  ...
  protocol.removeObserver(static_cast<cn::ICryptoNoteProtocolObserver*>(this));
  core.removeObserver(static_cast<cn::ICoreObserver*>(this));
  state = NOT_INITIALIZED;
