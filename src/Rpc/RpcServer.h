...
private:
  ...
  bool f_on_transactions_by_payment_id(const F_COMMAND_RPC_GET_TRANSACTIONS_BY_PAYMENT_ID::request& req, F_COMMAND_RPC_GET_TRANSACTIONS_BY_PAYMENT_ID::response& res);
